            ...
            <div class="row align-items-center py-5">
               ...
               <div class="col-md-7 col-lg-6">
                  <div class="rounded-3 overflow-hidden">
                     <img src="{{ asset('assets/img/portfolio/placeholder-image.png') }}" alt="gambar hero" class="img-fluid">
                  </div>
               </div>
            </div>
         </div>
      ...
      <div class="container">
         ...
         <div class="mt-5 text-center d-none">
            ...
            <div class="d-flex align-items-center justify-content-center">
               <img src="{{ asset('assets/img/icon-search-not-found.svg') }}" alt="" class="img-fluid">
               <div class="mx-3 mt-4">
            ...
            @for ($i = 0; $i < 4; $i++)
               <div class="col-md-6 mb-4">
                  <div class="card card-body rounded-3 h-100 shadow-sm">
                     <div class="rounded-3 overflow-hidden">
                        <img src="{{ asset('assets/img/portfolio/image-portfolio.png') }}" alt="gambar portfolio" class="img-fluid w-100">
                     </div>
