                     ...
                     <div class="row mt-5">
                        <div class="col-md-6 mt-md-5 mt-3">
                           <div class="card card-body rounded-4 h-100 border-0 py-5 shadow-sm">
                              <div class="text-center">
                                 <img src="{{ asset('assets/img/whatsapp.svg') }}" alt="icon whatsapp" class="img-fluid mb-4">
                        ...
                        <div class="col-md-6 mt-md-5 mt-3">
                           <div class="card card-body rounded-4 h-100 border-0 py-5 shadow-sm">
                              <div class="text-center">
                                 <img src="{{ asset('assets/img/users.svg') }}" alt="icon users" class="img-fluid mb-4">
            ...
            <div class="row">
               ...
               <div class="col-lg-6">
                  <div class="card ms-lg-5 px-lg-5 border-0 bg-transparent">
                     ...
                     <p class="text-dark-5 small mb-4"><img src="{{ asset('assets/img/customer-service-icon.svg') }}" alt="customer service icon" class="img-fluid">
      ...
      <div class="background-banner-about">
         <div class="container">
            <div class="row align-items-center">
               ...
               <div class="col-md-5">
                  <img src="{{ asset('assets/img/about/image-banner.png') }}" alt="gambar banner" class="img-fluid">
               </div>
            </div>
         </div>
      </div>
