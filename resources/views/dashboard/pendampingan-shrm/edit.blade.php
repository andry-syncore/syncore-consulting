...
@section('content')
   <div class="card card-body border-0">
      ...
      @endif
      <form class="row" action="{{ route('pendampingan-shrm.update', $pendampingan) }}" method="post" enctype="multipart/form-data">
         @csrf
         @method('PUT')
         ...
         <div class="col-12">
            <div class="mb-3">
               ...
               <input class="form-control @error('name') is-invalid @enderror" id="name" name="name" type="text" value="{{ old('name', $pendampingan->name) }}"
         ...
         <div class="col-md-6">
            ...
            <div class="mb-3">
               ...
               <input id="background" name="background" type="hidden" value="{{ old('background', $pendampingan->background) }}">
         ...
         <div class="col-md-6">
            ...
            <div class="mb-3">
               ...
               <input id="scope" name="scope" type="hidden" value="{{ old('scope', $pendampingan->scope) }}">
         ...
         <div class="col-md-6">
            <div class="mb-3">
               ...
               <input id="objective" name="objective" type="hidden" value="{{ old('objective', $pendampingan->objective) }}">
         ...
         <div class="col-md-6">
            <div class="mb-3">
               ...
               <input id="result" name="result" type="hidden" value="{{ old('result', $pendampingan->result) }}">
