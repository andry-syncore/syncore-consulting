...
@section('content')
   <div class="card card-body border-0">
      ...
      <form class="row" id="form-feature" action="{{ route('pendampingan-saab.update', $pendampingan) }}" method="post">
         @csrf
         @method('PUT')
         ...
         <div class="col-12">
            <div class="mb-3">
               ...
               <input class="form-control form-saab" id="name" name="name" type="text" value="{{ $pendampingan->name }}"
         ...
         <div class="col-12">
            <div class="mb-3">
               ...
               <input id="objective" name="objective" type="hidden" value="{{ $pendampingan->objective }}">
         ...
         <div class="col-md-6">
            <div class="mb-3">
               ...
               <input id="benefit" name="benefit" type="hidden" value="{{ $pendampingan->benefit }}">
         ...
         <div class="col-md-6">
            <div class="mb-3">
               ...
               <input id="output" name="output" type="hidden" value="{{ $pendampingan->output }}">
         ...
         <div class="col-12">
            <div class="mb-3">
               ...
               <table class="table-borderless w-100 table-padding-none table" id="feature-table">
                  @foreach ($pendampingan->feature->name as $name)
                     <tr>
                        <td>
                           <div class="row mb-3">
                              <div class="col-md-6">
                                 <input class="form-control form-saab" name="feature[]" type="text" placeholder="Contoh: Dashboard, Setup, Anggaran, dll" value="{{ $name }}">
                                 <div class="invalid-feedback"></div>
                              </div>
                              <div class="col-md-4">
                                 @if ($loop->index == 0)
                           ...
                           <input id="fitur-1" name="feature_content[]" type="hidden" value="{{ $pendampingan->feature->content[$loop->index] }}">
         ...
         <div class="col-12">
            <div class="mb-3">
               ...
               <input id="work_program" name="work_program" type="hidden" value="{{ $pendampingan->work_program }}">
            ...
            <div class="mb-3">
               ...
               <table class="table-borderless table-padding-none table">
                  <tr>
                     ...
                     <td>
                        <input class="form-control form-saab" name="cost_first_year" type="text" value="{{ $pendampingan->cost->cost_first_year }}">
                        <div class="invalid-feedback"></div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                        <input class="form-control form-saab" name="cost_next_year" type="text" value="{{ $pendampingan->cost->cost_next_year }}">
                        <div class="invalid-feedback"></div>
                     </td>
                  </tr>
                  <tr>
                     ...
                     <td>
                        <input id="facilities" name="facilities" type="hidden" value="{{ $pendampingan->cost->facilities }}">
                  ...
                  <tr>
                     ...
                     <td>
                        <input id="demo" name="demo" type="hidden" value="{{ $pendampingan->cost->demo }}">
